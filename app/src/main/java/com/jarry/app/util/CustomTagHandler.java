...
public class CustomTagHandler implements Html.TagHandler {
    ...
    public CustomTagHandler(final Context context, final OnCommentClickListener listener) {
        ...
        mCommentatorSpan = new BaseClickableSpan() {
            ...
            public void onClick(View widget) {
                if (listener != null) {
                    UserComm UserComm = (UserComm) widget.getTag(KEY_COMMENTATOR);
                    listener.onCommentatorClick(widget, UserComm);
                }
            }
        };
        mReceiverSpan = new BaseClickableSpan() {
            ...
            public void onClick(View widget) {
                if (listener != null) {
                    UserComm UserComm = (UserComm) widget.getTag(KEY_RECEIVER);
                    listener.onReceiverClick(widget, UserComm);
                }
            }
        ...
        mContentSpan = new BaseClickableSpan() {
            ...
            public void onClick(View widget) {
                if (listener != null) {
                    UserComm commentator = (UserComm) widget.getTag(KEY_COMMENTATOR);
                    UserComm receiver = (UserComm) widget.getTag(KEY_RECEIVER);
    ...
    public interface OnCommentClickListener {
        // 点击评论者
        void onCommentatorClick(View view, UserComm commentator);

        // 点击接收者
        void onReceiverClick(View view, UserComm receiver);

        //　点击评论内容
        void onContentClick(View view, UserComm commentator, UserComm receiver);
